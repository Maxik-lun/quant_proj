...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in tinvest/grpc/users_pb2_grpc.py depends on'
...
class UsersServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMarginAttributes = channel.unary_unary(
                ...
                request_serializer=tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesResponse.FromString,
                _registered_method=True)
        self.GetUserTariff = channel.unary_unary(
                '/tinkoff.public.invest.api.contract.v1.UsersService/GetUserTariff',
                request_serializer=tinvest_dot_grpc_dot_users__pb2.GetUserTariffRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_users__pb2.GetUserTariffResponse.FromString,
                _registered_method=True)
        self.GetInfo = channel.unary_unary(
                '/tinkoff.public.invest.api.contract.v1.UsersService/GetInfo',
                request_serializer=tinvest_dot_grpc_dot_users__pb2.GetInfoRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_users__pb2.GetInfoResponse.FromString,
                _registered_method=True)
...
def add_UsersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMarginAttributes': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesResponse.SerializeToString,
            ),
            'GetUserTariff': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUserTariff,
                    request_deserializer=tinvest_dot_grpc_dot_users__pb2.GetUserTariffRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_users__pb2.GetUserTariffResponse.SerializeToString,
            ),
            'GetInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.GetInfo,
                    request_deserializer=tinvest_dot_grpc_dot_users__pb2.GetInfoRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_users__pb2.GetInfoResponse.SerializeToString,
            ),
    }
...
class UsersService(object):
    ...
    def GetMarginAttributes(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.UsersService/GetMarginAttributes',
            tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesRequest.SerializeToString,
            tinvest_dot_grpc_dot_users__pb2.GetMarginAttributesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetUserTariff(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.UsersService/GetUserTariff',
            tinvest_dot_grpc_dot_users__pb2.GetUserTariffRequest.SerializeToString,
            tinvest_dot_grpc_dot_users__pb2.GetUserTariffResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.UsersService/GetInfo',
            tinvest_dot_grpc_dot_users__pb2.GetInfoRequest.SerializeToString,
            tinvest_dot_grpc_dot_users__pb2.GetInfoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
