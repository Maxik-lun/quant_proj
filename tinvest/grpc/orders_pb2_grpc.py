...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in tinvest/grpc/orders_pb2_grpc.py depends on'
...
class OrdersStreamServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TradesStream = channel.unary_stream(
                ...
                request_serializer=tinvest_dot_grpc_dot_orders__pb2.TradesStreamRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_orders__pb2.TradesStreamResponse.FromString,
                _registered_method=True)
        self.OrderStateStream = channel.unary_stream(
                '/tinkoff.public.invest.api.contract.v1.OrdersStreamService/OrderStateStream',
                request_serializer=tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamResponse.FromString,
                _registered_method=True)
...
def add_OrdersStreamServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TradesStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=tinvest_dot_grpc_dot_orders__pb2.TradesStreamRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_orders__pb2.TradesStreamResponse.SerializeToString,
            ),
            'OrderStateStream': grpc.unary_stream_rpc_method_handler(
                    servicer.OrderStateStream,
                    request_deserializer=tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamResponse.SerializeToString,
            ),
    }
...
class OrdersStreamService(object):
    ...
    def TradesStream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.OrdersStreamService/TradesStream',
            tinvest_dot_grpc_dot_orders__pb2.TradesStreamRequest.SerializeToString,
            tinvest_dot_grpc_dot_orders__pb2.TradesStreamResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def OrderStateStream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.OrdersStreamService/OrderStateStream',
            tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamRequest.SerializeToString,
            tinvest_dot_grpc_dot_orders__pb2.OrderStateStreamResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class OrdersServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PostOrderAsync = channel.unary_unary(
                ...
                request_serializer=tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncResponse.FromString,
                _registered_method=True)
        ...
        self.GetOrderPrice = channel.unary_unary(
                ...
                request_serializer=tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceRequest.SerializeToString,
                response_deserializer=tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceResponse.FromString,
                _registered_method=True)
...
def add_OrdersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PostOrderAsync': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncResponse.SerializeToString,
            ),
            ...
            'GetOrderPrice': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceRequest.FromString,
                    response_serializer=tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class OrdersService(object):
    ...
    def PostOrderAsync(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.OrdersService/PostOrderAsync',
            tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncRequest.SerializeToString,
            tinvest_dot_grpc_dot_orders__pb2.PostOrderAsyncResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrderPrice(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.OrdersService/GetOrderPrice',
            tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceRequest.SerializeToString,
            tinvest_dot_grpc_dot_orders__pb2.GetOrderPriceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
